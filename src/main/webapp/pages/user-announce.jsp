                            ...
                            <c:forEach items="${pageInfo.list}" var="announce" varStatus="num">
                                <tr>
                                    ...
                                    <td class="text-center">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="box-body">
                                                                <div class="form-horizontal">
                                                                   ...
                                                                   &lt;%&ndash; <input type="hidden" name="travelId" value="${travel.travelId}">&ndash;%&gt;

                                                                    <div class="form-group">
                                                                        <label for="username" class="col-sm-2 control-label">公告主题:</label>
                                                                        <div class="col-sm-10">
                                                                            <input  type="text" class="form-control" name="announceTitle" value="${announce.announceTitle}" >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="userEmail" class="col-sm-2 control-label">公告内容:</label>
                                                                        <div class="col-sm-10">
                                                                            <input  type="text" class="form-control" name="announceContent" value="${announce.announceContent}" >
                                                                        </div>
                                                                    </div>
                                       ...
                                       <%-- <a href="${pageContext.request.contextPath}/user/announce.do?announceId=${announce.announceId}" class="btn bg-maroon btn-xs" onclick="javascript:return del();">删除</a>
                                        <script>
                                            function del() {
